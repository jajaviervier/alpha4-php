...
filtrarTabla(desde,hasta){
    if( (new Date(desde).getTime() >= new Date(hasta).getTime()))
    {
        ...
        $.ajax({
            ...
            url: "views/modulos/funcionarios/selectFuncionarios.php",
        })
...
$('#tablaFuncionarios').hide(50);
$('#cuerpoFuncionarios').html( this.contentTablaFunc);
                 }else{
                    $('#tablaFuncionarios').show(50);
                    $('#cuerpoFuncionarios').html( this.contentTablaFunc);
                    var table = $('#tablaFuncionarios').DataTable({
                        language: {
                            "decimal": "",

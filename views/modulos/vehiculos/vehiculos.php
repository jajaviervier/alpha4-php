<script src="views/modulos/vehiculos/vehiculos.js">
...
<div class="content-wrapper">
 ...
 <div class="row">
<form class="col-md-12 card" onsubmit="vehi.filtrarTablaVehi(fechaInicio.value,fechaFinal.value); return false">
<div class="row">
<!-- Dede-->
<div class="col-md-4 ">
...
<table class="table table-dark table-bordered"  id="tablaVehiculos">
  <thead>
    <tr>
      <th scope="col">#</th>

class Usuarios{
    ...
    filtrarTablaChac(desde,hasta){
        if( (new Date(desde).getTime() >= new Date(hasta).getTime()))
        {
            ...
            $.ajax({
                ...
                url: "views/modulos/usuarios/selectUsuarios.php",
            })
             .done(function( data, textStatus, jqXHR ) {
                ...
                data.forEach(datos => {
                    ...
                    this.contentTablaChac+="</span> creo el Usuario : <span  class='text-primary' ' onclick='modal.cargarUsuario("+datos.idObjeto+")'>"+datos.serie+" </span></td>";
                    this.contentTablaChac+="</tr>";
    ...
    $('#tablaUsuarios').hide(50);
    $('#cuerpoUsuarios').html( this.contentTablaChac);
                     }else{
                        $('#tablaUsuarios').show(50);
                        $('#cuerpoUsuarios').html( this.contentTablaChac);

<script src="views/modulos/radios/radios.js">
...
<div class="content-wrapper">
 ...
 <div class="row">
<form class="col-md-12 card" onsubmit="radi.filtrarTablaFunc(fechaInicio.value,fechaFinal.value); return false">
<div class="row">
<!-- Dede-->
<div class="col-md-4 ">
...
<table class="table table-dark table-bordered"  id="tablaRadios">
  <thead>
    <tr>
      <th scope="col">#</th>
